...
| `ready` | display → presenter | — | Display finished loading; presenter re-pushes all current state (slide, fontScale, slideTheme and the line-mode settings) to sync |
