...
2. **Spawn initial research tasks** using subrecipes:
    - **find_files** (codebase-locator): Find all files related to the ticket/task
    - **analyze_code** (codebase-analyzer): Understand current implementation
    - **find_patterns** (pattern-finder): Find similar features to model after
...
sub_recipes:
  - name: "find_files"
    promptfile: "#file:codebase-locator.prompt.md"
  
  - name: "analyze_code"
    promptfile: "#file:codebase-analyzer.prompt.md"
  
  - name: "find_patterns"
    promptfile: "#file:pattern-finder.prompt.md"
