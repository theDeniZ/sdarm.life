    ...
    <footer>
      ...
      <div className="footer-bottom">
        ...
        <div className="f-social">
          {/* Facebook */}
          <a href="https://www.facebook.com/sdarmchurch" target="_blank" rel="noopener noreferrer" aria-label="Facebook">
          ...
          {/* Instagram */}
          <a href="https://www.instagram.com/sdarmchurch" target="_blank" rel="noopener noreferrer" aria-label="Instagram">
            <svg viewBox="0 0 24 24" fill="currentColor">
          ...
          {/* YouTube */}
          <a href="https://www.youtube.com/sdarmchurch" target="_blank" rel="noopener noreferrer" aria-label="YouTube">
            <svg viewBox="0 0 24 24" fill="currentColor">
