    ...
    <div className="reader">
      {showChords && (
        <div className="transpose-bar">
          <button className="transpose-btn" onClick={() => changeTranspose(-1)} aria-label="Transpose down one semitone">
            −1
          </button>
          ...
          {transpose !== 0 && (
            <button className="transpose-btn transpose-btn--reset" onClick={resetTranspose} aria-label="Reset transposition">
              ↺
            </button>
          )}
        </div>
