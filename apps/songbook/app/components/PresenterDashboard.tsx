...
import { expandParts, buildLineSlides, getOriginalParts, getAvailableLanguages, getSiteTheme } from '@/app/lib/format';
...
interface PresenterControlsProps {
  ...
  setSlideTheme: (fn: (v: 'dark' | 'light') => 'dark' | 'light') => void;
  ...
  return (
    <div className="presenter__controls">
      ...
      <div className="presenter__ctrl-main">
        ...
        <button
          className="presenter__tb-btn presenter__tb-btn--icon"
...
function SlideView({ song, index, parts, verseNumbers, variant, slideTheme }: SlideViewProps) {
  ...
  return (
    <div
      className={`pres-slide pres-slide--${variant}${isTitleSlide ? ' pres-slide--title-slide' : ''}`}
