...
import { createPost, updatePost, type UpdatePostPayload } from './repository';
  ...
  return (
    <form className="form-card" onSubmit={submit}>
      ...
      <div className="form-row">
        ...
        <ImagePicker value={form.thumbKey} onChange={(key) => set('thumbKey', key)} />
      </div>

      <div className="form-row">
        <label>Cover alt text</label>
        <input type="text" value={form.coverAlt} onChange={(e) => set('coverAlt', e.target.value)} />
      </div>
      ...
      <div className="form-actions">
        ...
        <button type="button" className="btn-ghost" onClick={() => router.push('/posts')}>
          Cancel
        </button>
      </div>
    </form>
