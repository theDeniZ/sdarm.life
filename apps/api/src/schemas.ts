...
export const TreasureTypeSchema = z.enum(['book', 'bible']);
...
export const TreasureSchema = z
	.object({
		...
		bibleCode: z.string().nullable().optional(),
		createdAt: z.string(),
		updatedAt: z.string(),
	})
	.openapi('Treasure');
...
export const BibleChapterSchema = z
	.object({
		translation: z.object({ code: z.string(), name: z.string() }),
...
export const ParallelChapterSchema = z
	.object({
		bookCode: z.string(),
		a: z.object({ code: z.string(), name: z.string(), chapter: z.number() }),
		b: z.object({ code: z.string(), name: z.string(), chapter: z.number() }),
