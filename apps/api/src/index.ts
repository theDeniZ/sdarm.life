...
app.use(
	...
	cors({
		origin: [
			...
			'https://web-sdarm-life-staging.pages.dev',
			'https://admin-sdarm-life-staging.pages.dev',
			'https://songs-sdarm-life-staging.pages.dev',
			'https://events-sdarm-life-staging.pages.dev',
			'https://treasures-sdarm-life-staging.pages.dev',
			'http://localhost:3000',
			'http://localhost:3001',
			'http://localhost:3002',
			'http://localhost:3003',
