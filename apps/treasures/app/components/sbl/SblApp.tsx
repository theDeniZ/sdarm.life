  ...
  return (
    <>
      ...
      <footer>
        ...
        <div className="fkind">SBL Edition · Sabbath Bible Lesson · original booklet layout</div>
        <div className="fnote">
          Content ©{' '}
          ...
          <br />
          Bible text from SDARM editions · Luther 1912 · King James · Синодальный
        </div>
        <div className="fset">
          Set in PT Serif & PT Sans · built by{' '}
          <a href="https://github.com/TheMaestr-o" target="_blank" rel="noopener">
            Sergio
          </a>
          ·{' '}
          <a href="https://github.com/TheMaestr-o/sbl" target="_blank" rel="noopener">
            source on GitHub
          </a>
        </div>
      </footer>
