...
export const metadata: Metadata = {
  title: 'Sabbath Bible Lesson — SBL Edition',
  description:
    'Die wöchentliche Sabbatschullektion im Layout des gedruckten Heftes — markieren, eigene Notizen schreiben, als PDF speichern. Deutsch, Englisch, Russisch.',
};
